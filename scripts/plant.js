...
fetch(`https://rlrnltlgmzclzpyumxli.supabase.co/rest/v1/plants${id}`, {
  method: "GET",
  headers: {
...
function showPlant(plant) {
  console.log(plant);
  document.querySelector(".plant_description h1").textContent = plant.titel;
  document.querySelector(".plant_description p").textContent = plant.description;
